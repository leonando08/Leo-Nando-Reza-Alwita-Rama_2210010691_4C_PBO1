...
Aplikasi ini menerima input berupa nama dan kode booking, dan memberikan output berupa informasi detail dari kode booking tersebut seperti info tambahan, infokamar, dan tanggal booking.
